...
VFS_API struct vfs_directory *vfs_find_directory(struct vfs_instance *i, char *directory_name);
VFS_API struct vfs_entry *vfs_find_file(struct vfs_instance *i, char *file_name, char *directory_name);
VFS_API struct vfs_entry *vfs_read_file(struct vfs_instance *i, char *file_name, char *directory_name);
VFS_API void vfs_new_file(struct vfs_instance *i, char *file_name, char *directory_name, void *data, int len);
VFS_API void vfs_append_to_file(struct vfs_instance *i, char *file_name, char *directory_name, void *data, int len);
VFS_API void vfs_write_at_file(struct vfs_instance *i, char *file_name, char *directory_name, void *data, int len, int pos);
